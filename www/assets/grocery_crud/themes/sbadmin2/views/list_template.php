<?php
	...
	$this->set_js_lib('vendor/datatables/jquery.dataTables.min.js');
	$this->set_js_lib('vendor/datatables/dataTables.bootstrap4.min.js');
	$this->set_js($this->default_theme_path.'/sbadmin2/js/datatables-extras.js');
	$this->set_js($this->default_theme_path.'/sbadmin2/js/datatables.js');
?>
...
<div class="grocerycrud-container">
	...
	<div class="dataTablesContainer">
		<?php if(!$unset_add){?>
			<a class="btn btn-primary btn-icon-split add_button" role="button" href="<?php echo $add_url?>">
